            ...
            using (MySqlCommand mySqlCommand = mySqlConnection.CreateCommand())
            {
                ...
                for (int totalLength = 0; totalLength < lineString.Length; totalLength += 100)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        LogHelper.WriteError(LogHelper.BuildLogEntity(fileName, executeStartTime, executeEndTime_assignment, String.Format("{0}, Cannot assign variable in InsertData.", fileName)), null);
                    }
                    ...
                    catch (Exception exception)
                    {
                        ...
                        LogHelper.WriteError(LogHelper.BuildLogEntity(fileName, executeStartTime, executeEndTime_parameterAdd, String.Format("{0}, Parameter Add : Fail, TransferFile Fail. {1}", fileName, exception)), null);
                    }
                    #endregion
